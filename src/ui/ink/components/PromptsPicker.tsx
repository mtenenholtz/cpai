...
export function PromptsPicker(props: {
  ...
  useInput((input, key) => {
    ...
    if (key.return) { props.onApply([...sel]); return; }
  ...
  return (
    <Box flexDirection="column" borderStyle="round" paddingX={1} height={props.height} width={props.width}>
      <Box height={1}><Text color="cyan">Prompts (space=toggle, Enter=apply, Esc=cancel)</Text></Box>
